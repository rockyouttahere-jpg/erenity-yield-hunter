...
__export(src_exports, {
  AggrDeferredEvmClientScheme: () => AggrDeferredEvmScheme,
  AggrDeferredEvmServerScheme: () => AggrDeferredEvmScheme2,
...
var x402UptoPermit2ProxyAddress = "0x4020e7393B728A3939659E5732F87fdd8e680002";
...
async function createUptoPermit2Payload(signer, x402Version, paymentRequirements) {
  ...
  const permit2Authorization = {
    from: signer.address,
    permitted: {
      token: (0, import_viem11.getAddress)(paymentRequirements.asset),
      amount: paymentRequirements.amount
    },
    ...
    deadline,
    witness: {
      to: (0, import_viem11.getAddress)(paymentRequirements.payTo),
      facilitator: (0, import_viem11.getAddress)(facilitatorAddress),
      validAfter
    }
  };
  ...
  const signature = await signer.signTypedData({
    ...
    message: {
      permitted: {
        token: (0, import_viem11.getAddress)(permit2Authorization.permitted.token),
        amount: BigInt(permit2Authorization.permitted.amount)
      },
      spender: (0, import_viem11.getAddress)(permit2Authorization.spender),
      nonce: BigInt(permit2Authorization.nonce),
      deadline: BigInt(permit2Authorization.deadline),
      witness: {
        to: (0, import_viem11.getAddress)(permit2Authorization.witness.to),
        facilitator: (0, import_viem11.getAddress)(permit2Authorization.witness.facilitator),
        validAfter: BigInt(permit2Authorization.witness.validAfter)
      }
    }
  });
...
var AggrDeferredEvmScheme = class {
  ...
  async createPaymentPayload(x402Version, paymentRequirements, _context) {
    ...
    const authorization = {
      ...
      to: (0, import_viem12.getAddress)(paymentRequirements.payTo),
      value: paymentRequirements.amount,
      validAfter: (now - 5).toString(),
      validBefore: (now + paymentRequirements.maxTimeoutSeconds).toString(),
      nonce
    ...
    const domain = {
      ...
      chainId,
      verifyingContract: (0, import_viem12.getAddress)(paymentRequirements.asset)
    };
    const signature = await this.sessionKeySigner.signTypedData({
      ...
      primaryType: "TransferWithAuthorization",
      message: {
        from: (0, import_viem12.getAddress)(authorization.from),
        to: (0, import_viem12.getAddress)(authorization.to),
        value: BigInt(authorization.value),
        validAfter: BigInt(authorization.validAfter),
        validBefore: BigInt(authorization.validBefore),
        nonce: authorization.nonce
...
// src/deferred/server/scheme.ts
var AggrDeferredEvmScheme2 = class {
  constructor() {
    this.scheme = "aggr_deferred";
  }
...
0 && (module.exports = {
  AggrDeferredEvmClientScheme,
  AggrDeferredEvmServerScheme,
  ExactEvmScheme,
  PERMIT2_ADDRESS,
  UptoEvmScheme,
  authorizationTypes,
